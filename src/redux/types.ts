...
export const LOADING_USER_AGREEMENT_MESAFE = "LOADING_USER_AGREEMENT";
export const GET_USER_AGREEMENT_MESAFE = 'GET_USER_AGREEMENT';
export const LOADING_USER_AGREEMENT_IPTAL = "LOADING_USER_AGREEMENT";
export const GET_USER_AGREEMENT_IPTAL = 'GET_USER_AGREEMENT';
...
export const DO_BULK_PAYMENT_LOADING = 'DoBulkPaymentLoading';
export const DO_BULK_PAYMENT_SUCCEED = 'DoBulkPaymentSucceed';
export const DO_BULK_PAYMENT_FAILED = 'DoBulkPaymentFailed';
...
export const LOADING_GET_STORE_LIST = 'LOADING_GET_STORE_LIST';
