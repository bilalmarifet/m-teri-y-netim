...
class AuthLoading extends React.Component<Props, State> {
  ...
  async   createNotificationtoken(
    ...
    if (notificationToken) {
      ...
      this.props.navigation.navigate( "HomeBaseWithItemsStack");
    } else {
  ...
  render() {
    return (
      <View style={{flex:1,justifyContent:'center',alignSelf:'center'}}>
         ...
         <Text style={{marginTop:10,color:colors.textColorLighter,fontStyle:"italic",textAlign:'center'}}>Bahçeşehire özel</Text>
